...
But first we have to set your GutHub credentials. Please edit the file `blue-green-pipeline-environments/applicationset-cluster-config.yaml`. It should looks like:
